...
import { Calendar, User, Hash, ChevronDown, Check, Loader2, ExternalLink, Copy, Eye, FileText, Mail, Share2, MessageCircle } from 'lucide-react';
          ...
          {status === 'success' ? (
            ...
            >
              ...
              <div className="flex flex-col gap-3 mt-6">
                ...
                <button
                  onClick={() => {
                    setStatus('idle');
                    setFormData({ id: '', name: '', course: 'Certified Blockchain Associate', grade: 'S', date: '' });
                    setTxHash('');
                  }}
            ...
            >
              <div className="mb-8 text-center">
                <h1 className="text-2xl font-bold text-white mb-2 tracking-tight">Issue New Certificate</h1>
                <p className="text-secondary text-sm">Fill in the details below to mint a new certificate.</p>
              </div>
